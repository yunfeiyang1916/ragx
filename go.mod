...
require (
	...
	github.com/cloudwego/eino-ext/components/document/loader/file v0.0.0-20250919093114-b7a34962a8d8
	github.com/cloudwego/eino-ext/components/document/loader/url v0.0.0-20250919093114-b7a34962a8d8
